...
public:
	...
	virtual vector<AutoCompleteCandidate> SuggestSchemaName(const AutoCompleteFilter &filter = {}) = 0;
	virtual vector<AutoCompleteCandidate> SuggestTableName(const AutoCompleteFilter &filter = {}) = 0;
	virtual vector<AutoCompleteCandidate> SuggestType() = 0;
	virtual vector<AutoCompleteCandidate> SuggestColumnName(const AutoCompleteFilter &filter = {}) = 0;
...
public:
	...
	vector<AutoCompleteCandidate> SuggestSchemaName(const AutoCompleteFilter &) override {
		return {};
	}
	vector<AutoCompleteCandidate> SuggestTableName(const AutoCompleteFilter &) override {
		return {};
	}
	vector<AutoCompleteCandidate> SuggestType() override {
		return {};
	}
	vector<AutoCompleteCandidate> SuggestColumnName(const AutoCompleteFilter &) override {
		return {};
	}
