//===----------------------------------------------------------------------===//
//                         DuckDB (shadow for smart_autocomplete)
//
// tokenizer.hpp
//
// Same as duckdb/extension/autocomplete/include/tokenizer.hpp; lives under
// src/include so #include "matcher.hpp" resolves to the extension matcher shadow
// instead of the submodule copy.
//
//===----------------------------------------------------------------------===//
